...
CinnabarIsland_MapEvents:
	...
	db 2 ; warp events
	warp_event  7,  5, CINNABAR_POKECENTER_1F, 1
	warp_event 14, 11, CINNABAR_GYM, 2

	db 0 ; coord events

	db 4 ; bg events
	bg_event  8,  5, BGEVENT_READ, CinnabarIslandPokecenterSign
	bg_event  9, 11, BGEVENT_READ, CinnabarIslandGymSign
	bg_event  7,  7, BGEVENT_READ, CinnabarIslandSign
	bg_event  5, 10, BGEVENT_ITEM, CinnabarIslandHiddenRareCandy

	db 1 ; object events
	object_event  9,  8, SPRITE_BLUE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CinnabarIslandBlue, EVENT_BLUE_IN_CINNABAR
